...
--
-- Host: localhost    Database: augusteight
-- ------------------------------------------------------
...
CREATE TABLE `orders` (
  ...
  `customer_id` decimal(5,0) DEFAULT NULL,
...
INSERT INTO `orders` VALUES (123,1234.23,'2021-08-08',234,123);
...
-- Dump completed on 2021-08-08 21:36:17
